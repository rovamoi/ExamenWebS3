				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							...
							<h1 class="cursive-font"> Configuration salaire </h1>	
						</div>
                        <div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight">
                            <form action="../../traitement/conf.php" method="POST" id="myForm">
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <h5 class="cursive-font">Montant:</h5>
                                        <input type="number" step="0.01" id="montant_kg" name="montant_kg" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
						...
						<div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight">
                            <h3 class="cursive-font">Salaire :</h3>
	...
	<script>
		...
		function createTable(table, data,formulaire) {
			...
			// for (let i = 0; i < data.length; i++) {
				...
				// thID.textContent = data[i].id_salaire;
				// tr.appendChild(thID);

				var thocc = document.createElement("td");
				thocc.textContent = data;
		...
		function createInitialTable() {
				var xhr = createXHR();
				xhr.open("GET", "../../traitement/conf.php");
				xhr.send(null);
