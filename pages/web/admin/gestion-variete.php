...
<html>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							...
							<h1 class="cursive-font">Gestion de Variété </h1>	
						</div>
						<div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight">
                            <form action="../../traitement/variete-the.php" id="myForm" method="POST">
								
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <h5 class="cursive-font">Nom du nouveau variété:</h5>
                                        <input type="text" id="nom_var" name="nom_var" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <h5 class="cursive-font">Occupation en m2:</h5>
                                        <input type="text" id="Occupation_var" name="Occupation_var" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <h5 class="cursive-font">rendement en kg / mois:</h5>
                                        <input type="text" id="rendement_kg_mois" name="rendement_kg_mois" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
									<input type="hidden" name="id_variete" id="id_variete">
								...
								<div class="tab">
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3 class="cursive-font">Tableau des Variétés :</h3>
	...
	<script>
		window.addEventListener("load", function () {
			...
			// 	var xhr = createXHR();
			// 	var form = new FormData(formulaire);

			// 	xhr.open("POST", "../traitement/variete-the.php");
			// 	xhr.send(form);
			...
			// 				createTable(table, retour, formulaire); // Mettre à jour le tableau
							

			// 				// Ajouter ici le code pour mettre à jour la table dans l'interface utilisateur sans actualiser la page
			// 			} else {
		...
		function createTable(table, data,formulaire) {
			...
			for (let i = 0; i < data.length; i++) {
				...
				thID.textContent = data[i].id_variete;
				tr.appendChild(thID);
				...
				var thocc = document.createElement("td");
				thocc.textContent = data[i].occupation_m2;
				tr.appendChild(thocc);

				var threndement_kg_mois = document.createElement("td");
				threndement_kg_mois.textContent = data[i].rendement_kg_mois;
				tr.appendChild(threndement_kg_mois);
				...
				buttonSuppr.addEventListener('click', function () {
					...
					xhrSuppr.open("POST", "../../traitement/variete-the.php");
				...
				buttonUpdate.addEventListener('click', function () {
					var id = data[i].id_variete;
					var nom = data[i].nom;
					var occupation = data[i].occupation_m2;
					var rendement = data[i].rendement_kg_mois;

					document.getElementById("nom_var").value = nom;
					document.getElementById("Occupation_var").value = occupation;
					document.getElementById("rendement_kg_mois").value = rendement;

					// Mettre à jour la valeur de l'action dans le formulaire
					document.getElementById("action").value = "update";

					// Mettre à jour l'ID de la variété dans le formulaire
					document.getElementById("id_variete").value = id;
				});
		...
		function createInitialTable() {
				var xhr = createXHR();
				xhr.open("GET", "../../traitement/variete-the.php");
				xhr.send(null);
