...
<html>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							...
							<h1 class="cursive-font">Gestion de Ceuilleur </h1>	
						</div>
						<div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight">
                            <form action="../../traitement/cueilleur.php" id="myForm" method="POST">
								
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <h5 class="cursive-font">Nom du cueilleur:</h5>
                                        <input type="text" id="nom" name="nom" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <h5 class="cursive-font">Genre du cueilleur:</h5>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <h5 class="cursive-font">Date de naissance:</h5>
                                        <input type="date" id="date_naissance" name="date_naissance" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
									<input type="hidden" name="id_cueilleur" id="id_cueilleur">
	...
	<script>
		window.addEventListener("load", function () {
			...
			// 	xhr.open("POST", "../traitement/cueilleur.php");
			// 	xhr.send(form);
		...
		function createTable(table, data,formulaire) {
			...
			for (let i = 0; i < data.length; i++) {
				...
				thID.textContent = data[i].id_cueilleur;
				tr.appendChild(thID);
				...
				thocc.textContent = data[i].genre;
				tr.appendChild(thocc);

				var thdate_naissance = document.createElement("td");
				thdate_naissance.textContent = data[i].date_naissance;
				tr.appendChild(thdate_naissance);
				...
				buttonSuppr.addEventListener('click', function () {
					...
					xhrSuppr.open("POST", "../../traitement/cueilleur.php");
				...
				buttonUpdate.addEventListener('click', function () {
					...
					var date_naissance = data[i].date_naissance;
					...
					document.getElementById("id_cueilleur").value = id;
				});
		...
		function createInitialTable() {
				var xhr = createXHR();
				xhr.open("GET", "../../traitement/cueilleur.php");
				xhr.send(null);
