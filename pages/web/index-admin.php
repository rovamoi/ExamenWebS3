		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo" class="cursive-font"><a href="index.html">Sweet <em>tea .</em></a></div>
				</div>
			</div>	
		</div>
	</nav>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							...
							<h1 class="cursive-font">Bienvenue Admin ! </h1>	
						</div>
								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3 class="cursive-font"> Mettez votre login et mot de passe .</h3>
											<form action="../traitement/verification-login.php" id="myForm" method="POST">
											<input type="hidden" name="is_admin" value="admin">
												...
												<div class="row form-group">
													<div class="col-md-12">
												<input type="submit" id="mySubmit" class="btn btn-primary btn-block" value="Valider">
													</div>
												</div>
											</form>	
										</div>
			...
			xhr.onreadystatechange = function () {
				if (xhr.readyState == 4) {
					if (xhr.status == 200) {
						...
						email.value = retour.mail; // Utilisez .value pour définir la valeur d'un champ input
						pwd.value = retour.mot_de_passe; // Utilisez .value pour définir la valeur d'un champ input
					} else {
